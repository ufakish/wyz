...
PRIVATE_BOT_MODE_MEM = int(getenv("PRIVATE_BOT_MODE_MEM", 100))
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://envs.sh/ovA.jpeg"
)
PING_IMG_URL = getenv(
    "PING_IMG_URL", "https://envs.sh/ovA.jpeg"
)
...
def time_to_seconds(time):
    stringt = str(time)
    return sum(int(x) * 100**i for i, x in enumerate(reversed(stringt.split(":"))))
